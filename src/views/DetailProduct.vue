...
export default {
  ...
  methods: {
    ubahEmitModal: function (e) {
      axios
      .put("http://localhost:3000/checkout/"+e.id,
      {
        id : e.id,
        jumlah: e.jumlah,
        size : e.size,
        products: {
          id: e.products.id,
          kode: e.products.kode,
          nama: e.products.nama,
          harga: e.products.harga,
          is_ready: e.products.is_ready,
          gambar: e.products.gambar,
        },
      })
        .then(() => {
